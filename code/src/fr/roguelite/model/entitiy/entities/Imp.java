...
public class Imp extends Monster {
    ...
    static String texturePath = "resources/texture/entity/monster/imp.png";
    ...
    public Imp() {
        ...
        boundingBox = new BoundingBox(location, 4 * scaleFactor, 6 * scaleFactor, 9 * scaleFactor, 10 * scaleFactor);
    }
}