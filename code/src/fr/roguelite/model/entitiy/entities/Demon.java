...
public class Demon extends Monster {
    ...
    static String texturePath = "resources/texture/entity/monster/big_demon.png";
    ...
    public Demon() {
        ...
        boundingBox = new BoundingBox(location, 9 * scaleFactor, 10 * scaleFactor, 16 * scaleFactor, 26 * scaleFactor);
    }
}