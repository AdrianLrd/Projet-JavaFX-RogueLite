...
public class Morc extends Monster {
    static String texturePath = "resources/texture/entity/monster/masked_orc.png";
    ...
    public Morc() {
        ...
        boundingBox = new BoundingBox(location, 3 * scaleFactor, 4 * scaleFactor, 10 * scaleFactor, 16 * scaleFactor);
    }
}
