...
public class Ogre extends Monster {
    ...
    static String texturePath = "resources/texture/entity/monster/ogre.png";
    ...
    public Ogre() {
        ...
        boundingBox = new BoundingBox(location, 8 * scaleFactor, 7 * scaleFactor, 17 * scaleFactor, 25 * scaleFactor);
    }
}
